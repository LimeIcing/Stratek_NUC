...
VALUES
    ...
    ('8806087605099', 'LG',				'34" Skærm 34UM88C-P',								3,	4990,	'Skaerm',	'LED-skærm, 34", 3440 x 1440 QHD, 60 hz opdatering, IPS panel, Widescreen 21:9 format, 300 cd/m2, 5000000:1 kontrast (dynamisk), 5 ms responstid, betragtningsvinkel: 178° (Horisontal) / 178° (Vertikal), DisplayPort / HDMI tilslutning, indbygget 7 watt højttalere, sort'),
    ('5397063966837', 'Dell',			'38" Skærm UltraSharp U3818DW',						0,	9216,	'Skaerm',	'LED-skærm, kurvet, 38" (37.5 til at se), 3840 x 1600, IPS, 300 cd/m², 1000:1, 5 ms, 2xHDMI, DisplayPort, højtalere, sort'),
    ('0887942152888', 'Lenovo',			'24" Skærm ThinkVision LT2423',						15,	1082,	'Skaerm',	'LCD-skærm, 24", 1920 x 1080, TN, 250 cd/m2, 1000:1, 5 ms, højtalere, business-sort'),
    ('4713147477609', 'Acer',			'21" Skærm K222HQL',								0,	696,	'Skaerm',	'LED-skærm, 21.5", 1920 x 1080 FullHD, TN, 200 cd/m2, 5 ms, HDMI, DVI, VGA, sort'),
    ('5397063744633', 'Dell',			'27" Skærm P2717H',									15, 1849,	'Skaerm',	'LED-skærm, 27", 1920 x 1080, IPS, 300 cd/m2, 1000:1, 6 ms, HDMI, VGA, DisplayPort, sort'),
    ('5397063744220', 'Dell',			'27" Skærm UltraSharp U2717D',						4,	3346,	'Skaerm',	'LED-skærm, 27", 2560 x 1440 QHD, IPS, 350 cd/m2, 1000:1, 6 ms, HDMI (MHL), DisplayPort, Mini DisplayPort, sort, HDMI, DisplayPort, Mini DisplayPort, Mobile High-Definition Link (MHL)'),
    ('5397063348053', 'Dell',			'24" Skærm UltraSharp U2414H',						15, 1749,	'Skaerm',	'LED-skærm, 24", 1920 x 1080 FullHD, IPS, 250 cd/m2, 1000:1, 2000000:1 (dynamisk), 8 ms, DisplayPort, Mini DisplayPort, 2 x MHL, sort'),
    ('4716659551782', 'ASUS',			'24" Skærm VS247HR',								10, 953,	'Skaerm',	'LED-skærm, 23.6", 1920 x 1080 FullHD, 75 hz opdatering, TN panel, Widescreen 16:9 format, 250 cd/m2 brightness, 50000000:1 kontrast (dynamisk), 2 ms responstid, betragtningsvinkel: 170° (Horisontal) / 160° (Vertikal), D-Sub / DVI-D / HDMI tilslutning, sort'),
